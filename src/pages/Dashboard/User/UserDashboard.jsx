...
import { FiHeart, FiMessageSquare, FiShoppingBag, FiStar } from 'react-icons/fi';
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        ...
                        <li>
                            <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Review">
                                {/* Review icon */}
                                <FiStar className="my-1.5 inline-block size-4" />
                                <span className="is-drawer-close:hidden">My Review</span>
                            </button>
                        </li>
                        <li>
                            <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Favorite Meal">
                                {/* Favorite icon */}
                                <FiHeart className="my-1.5 inline-block size-4" />
